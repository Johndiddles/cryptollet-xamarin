...
namespace Cryptollet.Modules.Wallet
{
    public class WalletViewModel: BaseViewModel
    {
        ...
        public override async Task InitializeAsync(object parameter)
        {
            ...
            List<Transaction> transactions = await _walletController.GetTransactions(reload);
            LatestTransactions = new ObservableCollection<Transaction>(transactions.Take(5));

            List<Coin> assets = await _walletController.GetCoins(reload);
        ...
        public ObservableCollection<Transaction> _latestTransactions;
        ...
        {
            await Shell.Current.DisplayAlert("success", "Added New Transaction", "Ok");
        }
        ...
        public decimal PortfolioValue { get => _portfolioValue; set { SetProperty(ref _portfolioValue, value); } }
